...
<head>
    ...
    <title>404 - Página No Encontrada | <?= esc($nombreClinica) ?></title>
...
<body>
    <div class="ds-error-container">
        ...
        <div class="ds-error-code">404</div>
        <h1 class="ds-error-title">Página No Encontrada</h1>
        ...
        <div class="ds-suggestions">
            ...
            <ul>
                ...
                <li>✓ Contactar al administrador si crees que esto es un error</li>
            </ul>
        </div>
