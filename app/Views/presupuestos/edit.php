...
<div class="ds-page">
    <div class="ds-page__header">
        <h1 class="ds-page__title">✏️ Editar Presupuesto</h1>
    </div>
        ...
        <div class="ds-col-12">
            <div class="ds-card">
                <div class="ds-card__header">
                    <h3 class="ds-card__title">Editar Presupuesto <?= $presupuesto['folio'] ?></h3>
                ...
                <div class="ds-card__body">
                    <?= form_open('/presupuestos/update/' . $presupuesto['id'], ['id' => 'presupuestoForm']) ?>
                        <div class="ds-row">
                            <!-- Datos principales -->
                            <div class="ds-col-md-6">
                                <div class="ds-form-group">
                                    ...
                                    <input type="text" name="folio" class="ds-input" 
                                           id="folio" value="<?= $presupuesto['folio'] ?>" readonly>
                                </div>
                            </div>
                            <div class="ds-col-md-6">
                                <div class="ds-form-group">
                                    ...
                                    <input type="text" name="fecha_emision" class="ds-input" 
                                           id="fecha_emision" value="<?= date('d/m/Y H:i', strtotime($presupuesto['fecha_emision'])) ?>" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="ds-col-md-6">
                                <div class="ds-form-group">
                                    ...
                                    <select name="id_paciente" class="ds-input ds-select" id="id_paciente" required>
                                        ...
                                        <option value="<?= $paciente['id'] ?>" <?= ($presupuesto['id_paciente'] == $paciente['id']) ? 'selected' : '' ?>>
                            ...
                            <div class="ds-col-md-6">
                                <div class="ds-form-group">
                                    ...
                                    <input type="date" name="fecha_vigencia" class="ds-input" 
                                           id="fecha_vigencia" value="<?= date('Y-m-d', strtotime($presupuesto['fecha_vigencia'])) ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="ds-col-md-6">
                                <div class="ds-form-group">
                                    ...
                                    <select name="id_usuario" class="ds-input ds-select" id="id_usuario" required>
                                        ...
                                        <option value="<?= $presupuesto['id_usuario'] ?>" selected>
                                            <?= $presupuesto['medico_nombre'] ?>
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="ds-col-md-6">
                                <div class="ds-form-group">
                                    ...
                                    <textarea name="observaciones" class="ds-input ds-textarea" 
                                              id="observaciones" rows="3"><?= $presupuesto['observaciones'] ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="ds-col-12">
                                ...
                                <div class="ds-table-responsive">
                                    <table class="ds-table ds-table--bordered" id="detallesTable">
                                        ...
                                        <tbody>
                                            <?php foreach ($presupuesto['detalles'] as $index => $detalle): ?>
                                            <tr>
                                                <td>
                                                    <select name="detalles[<?= $index ?>][id_servicio]" class="ds-input ds-select servicio-select" required>
                                                        <option value="">Seleccionar</option>
                                                        <?php foreach ($servicios as $servicio): ?>
                                                        <option value="<?= $servicio['id'] ?>" 
                                                                data-precio="<?= $servicio['precio_base'] ?>"
                                                                <?= ($detalle['id_servicio'] == $servicio['id']) ? 'selected' : '' ?>>
                                                            <?= $servicio['nombre'] ?>
                                                        </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                ...
                                                <td>
                                                    <input type="text" name="detalles[<?= $index ?>][descripcion]" 
                                                           class="ds-input descripcion-input" value="<?= $detalle['descripcion'] ?>">
                                                </td>
                                                <td>
                                                    <input type="number" name="detalles[<?= $index ?>][cantidad]" 
                                                           class="ds-input cantidad-input" 
                                                           value="<?= $detalle['cantidad'] ?>" min="0.01" step="0.01" required>
                                                </td>
                                                <td>
                                                    <input type="number" name="detalles[<?= $index ?>][precio_unitario]" 
                                                           class="ds-input precio-input" 
                                                           value="<?= $detalle['precio_unitario'] ?>" min="0" step="0.01" required>
                                                </td>
                                                <td>
                                                    <input type="number" name="detalles[<?= $index ?>][descuento_porcentaje]" 
                                                           class="ds-input descuento-input" 
                                                           value="<?= $detalle['descuento_porcentaje'] ?>" min="0" max="100" step="0.01">
                                                </td>
                                                <td>
                                                    <input type="text" class="ds-input subtotal-text" 
                                                           value="<?= $detalle['subtotal'] ?>" readonly>
                                                    <input type="hidden" name="detalles[<?= $index ?>][subtotal]" class="subtotal-hidden" value="<?= $detalle['subtotal'] ?>">
                                                </td>
                                                <td>
                        ...
                        <div class="ds-row">
                            ...
                            <div class="ds-col-md-4">
                                <div class="ds-form-group">
                                    ...
                                    <input type="text" name="subtotal_display" class="ds-input" id="subtotal" value="<?= $presupuesto['subtotal'] ?>" readonly>
                                </div>
                                <div class="ds-form-group">
                                    <label for="iva" class="ds-label">IVA (16%):</label>
                                    <input type="text" name="iva_display" class="ds-input" id="iva" value="<?= $presupuesto['iva'] ?>" readonly>
                                </div>
                                <div class="ds-form-group">
                                    <label for="total" class="ds-label">Total:</label>
                                    <input type="text" name="total_display" class="ds-input ds-font-bold" id="total" value="<?= $presupuesto['total'] ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ds-row">
                            <div class="ds-col-12 ds-flex ds-gap-2">
                                <button type="submit" class="ds-btn ds-btn--primary">Actualizar Presupuesto</button>
...
<script>
let rowIndex = <?= count($presupuesto['detalles']) ?>;
